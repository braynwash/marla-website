...
<footer>
	<div class="content">
		<!-- To "center" the content, all elements in the footer are in the class below with flex styling applied. -->
		<div class="wrapper">
